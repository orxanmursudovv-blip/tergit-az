...
const ADDICTIONS = [
  {
    ...
    icon: '📱',
    level: 'orta',
    tags: [{ label: 'Davranış asılılığı', color: '#6366f1' }, { label: 'Gənclərə təsir', color: '#0ea5e9' }],
  ...
  },
  {
    ...
    icon: '🎮',
    level: 'orta',
    tags: [{ label: 'Davranış asılılığı', color: '#6366f1' }, { label: 'Dopamin sistemi', color: '#f59e0b' }],
  ...
  },
  {
    ...
    icon: '🚬',
    level: 'yuksek',
    tags: [{ label: 'Fiziki asılılıq', color: '#ef4444' }, { label: 'Nikotin', color: '#f97316' }],
  ...
  },
  {
    ...
    icon: '☕',
    level: 'asagi',
    tags: [{ label: 'Yüngül asılılıq', color: '#22c55e' }, { label: 'Yuxuya təsir', color: '#8b5cf6' }],
  ...
  },
  {
    ...
    icon: '🍔',
    level: 'orta',
    tags: [{ label: 'Davranış', color: '#6366f1' }, { label: 'Terapiya effektivdir', color: '#10b981' }],
  ...
  },
  {
    ...
    icon: '🍷',
    level: 'yuksek',
    tags: [{ label: 'Fiziki asılılıq', color: '#ef4444' }, { label: 'Mütəxəssis lazım', color: '#f97316' }],
  ...
  },
  {
    ...
    icon: '💊',
    level: 'yuksek',
    tags: [{ label: 'Yüksək risk', color: '#ef4444' }, { label: 'Tibbi nəzarət', color: '#f97316' }],
...
function AddictionCard({ addiction }) {
  ...
  return (
    <div className="addiction-card">
      <div className="addiction-card__icon-wrap" aria-hidden="true">
        <span className="addiction-card__icon">{addiction.icon}</span>
      </div>
      <h3>{addiction.name}</h3>
      <p>{addiction.description}</p>
      {addiction.tags && (
        <div className="addiction-card__tags">
          {addiction.tags.map((tag, i) => (
            <span key={i} className="addiction-tag" style={{ background: tag.color + '1a', color: tag.color }}>
              {tag.label}
            </span>
          ))}
        </div>
